...
const ViewResults: React.FC<IViewResults> = ({
    isOpen,
    setTicker,
    stockCard,
    setStockCard,
    ...
    const searchCard = useMemo(() => {
        ...
        return stockCard.map((value) => {
            return (
                <div
                    onClick={companyClick(value.ticker)}
                    onMouseMove={companyMouseMoveHandler(value.ticker)}
                >
                    <CompanySearch
                        isActice={value.isActice}
    ...
    return (
        <div
            ...
            className={ViewResultsCss.ViewResultsWrapper}
        >
            {searchCard}
        </div>
    );
